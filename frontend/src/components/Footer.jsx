    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-2">
            <h3 className="text-2xl font-bold mb-4">
              <span className="text-blue-400">Portfolio</span>Craft
            </h3>
            <p className="text-gray-300 mb-4 max-w-md">
              Create stunning portfolios without writing a single line of code. 
              Drag, drop, and customize your way to a professional online presence.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2025 PortfolioCraft. All rights reserved. Built for creators who want to showcase their work without the hassle of coding.</p>
        </div>
      </div>
    </footer>
  )
